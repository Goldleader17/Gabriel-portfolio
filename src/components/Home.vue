    ...
    <div class="body-con" id="home">
        <div class="body-subcon flex flex-wrap justify-center lg:justify-around items-center">
            ...
            <div class=" order-1 pr-4 lg:pr-0">
                <div>
                    <a href="https://github.com/Goldleader17" target="_blank" id="github" :class="{ 'animate-left': githubVisible }">
                        <span class="home-icon icon-[uil--github-alt]"></span>
                    </a>
                </div>
                <div>
                    <a href="mailto:ezeriohagabriel@gmail.com?subject=Job%20Inquiry&body=Hello%20Gabriel%2C%20I%20am%20interested%20in%20working%20with%20you." target="_blank" id="twitter" :class="{ 'animate-left': titleVisible }">
            ...
            <div class=" order-2 lg:order-3">
                <img src="/img/gabriel3-img.jpg" alt="gabriel" class="rounded-full w-48 sm:w-64"  id="image" :class="{ 'animate-right': imageVisible }">
            </div>

            <!--Summary-->
            <div class=" order-3 lg:order-2 pt-10">
                <div id="title" :class="{ 'animate-left': titleVisible }">
                    <div class="gen-header-text">Hi, I'm Gabriel Ezerioha</div>
                ...
                <div class=" text-gray-600 dark:text-white text-lg mt-4 mb-8 max-w-80">
                    I am a full-stack web developer with a BSc in Software Development and 4+ years of experience.
                </div>
